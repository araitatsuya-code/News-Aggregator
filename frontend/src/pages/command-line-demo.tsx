...
const sampleNews = [
  {
    ...
    tags: ['OpenAI', 'GPT', 'AI', '機械学習'],
    ai_confidence: 0.95,
  },
  {
    id: '2',
    title: 'Google、機械学習の新しいフレームワークを公開',
    original_title: 'Google Releases New Machine Learning Framework',
    ...
    language: 'ja' as const,
    tags: ['Google', 'フレームワーク', '機械学習', '開発者'],
    ai_confidence: 0.88,
  },
  {
    id: '3',
    title: 'Meta、VRとAIを組み合わせた新技術を発表',
    original_title: 'Meta Announces New VR-AI Integration Technology',
    ...
    language: 'ja' as const,
    tags: ['Meta', 'VR', 'AI', 'メタバース'],
    ai_confidence: 0.92,
  },
  {
    id: '4',
    title: 'Microsoft、Azure AIサービスを拡張',
    original_title: 'Microsoft Expands Azure AI Services',
    ...
    language: 'ja' as const,
    tags: ['Microsoft', 'Azure', 'クラウドAI', '企業向け'],
    ai_confidence: 0.90,
  },
  {
    id: '5',
    title: 'Tesla、自動運転技術の最新アップデートを公開',
    original_title: 'Tesla Releases Latest Autonomous Driving Update',
